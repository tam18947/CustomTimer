...
public partial class MainForm : Form
{
    ...
    {
        MessageBox.Show("CustomTimer v1.1.1", "バージョン情報", MessageBoxButtons.OK, MessageBoxIcon.Information);
    }
    #endregion
    ...
    private void ControlSizeChange(Label control)
    {
        int val = 0;
    ...
    private Point ResizeFont(Label control, float emSize)
    {
    ...
    private Point GetControlLocation(Label control)
    {
    ...
    private void FormSizeChange(Label control)
    {
